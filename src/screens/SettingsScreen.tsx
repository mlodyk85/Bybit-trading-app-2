...
export const SettingsScreen: React.FC<SettingsScreenProps> = ({
  ...
  const handleUpdate = async () => {
    ...
    if (success) {
      Alert.alert('Sukces', 'Klucze API zostały pomyślnie zaktualizowane.');
    } else {
      Alert.alert('Błąd', 'Nie udało się połączyć przy użyciu podanych kluczy.');
    }
  };
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statusBox}>
          ...
          <Text
            style={[
              styles.statusValue,
              { color: connectionState === 'connected' ? '#00E676' : '#FF5252' },
            ]}
          >
            {connectionState === 'connected'
              ? 'Aktywne i Autoryzowane'
          ...
          {intervals.map((sec) => (
            <TouchableOpacity
              ...
              style={[
                ...
                autoRefreshInterval === sec && styles.intervalOptionSelected,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  autoRefreshInterval === sec && styles.intervalOptionTextSelected,
                ]}
              >
                {sec} sec
              </Text>
        ...
        <View style={styles.buttonRow}>
          ...
          >
            {isTesting ? (
              ...
              <Text style={styles.testButtonText}>Testuj</Text>
            )}
          </TouchableOpacity>
        </View>
      </View>
